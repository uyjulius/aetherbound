...
export const QUESTS = {
  ...
  engine: {
    ...
    // The main line advances through four stages and displayed none of them,
    // so the journal showed a returning player the same sentence at hour one
    // and hour twenty — on the single entry they are most likely to open
    // after a week away. The side quests had this and the main quest did not.
    stages: [
      'The Guild will not say what the Engine House is for. Ask in Solmere.',
      'The workings under the city are recent, not ancient. Somebody built them, and lately.',
      'The Ferran Outpost was keeping something awake. Follow the power back to its source.',
      'The Ninth Well is open, and something far below has answered the machinery.',
    ],
  },
  after: {
    ...
    stages: [
      'The world is changed and the roads still go where they went. Walk them again and see who is left.',
    ],
  },
  firstengine: {
  ...
  // --- the cast ----------------------------------------------------------
  idris: { name: 'The Last Blade of Ashenhall', kind: 'recruit', what: 'Idris will travel with you if the hall is settled.', where: 'the Weeping Wood' },
  ...
  maret: { name: 'The Broken Standard', kind: 'recruit', what: 'Maret has a countersign and no army left to give it to.', where: 'the Ferran Outpost' },
  tam: { name: 'Child of the Bramblewaste', kind: 'recruit', what: 'Something in the bramble has been following the party. It is a child.', where: 'the road, once the world has broken' },
  ...
  kestrel: { name: 'The Vellum Archivist', kind: 'recruit', what: 'Kestrel has read about everywhere and been nowhere.', where: 'Solmere, once the world has broken' },
  oda: { name: 'The Still Water', kind: 'recruit', what: 'The grandmaster will teach you if you can stand in front of him.', where: 'Marrow & Salt, the shop in Harrowmere' },
  rusk: { name: 'Salvaged', kind: 'recruit', what: 'Eleven years against a wall. Somebody should ask it to move.', where: 'the Engine House, inside Solmere' },
  ...
  gallery: { name: 'The Heavy End', kind: 'story', what: 'Bastian returns to the place he stopped lifting things for money.', where: 'Solmere' },
  ...
  names: { name: 'Sixty-One Names', kind: 'story', what: 'Kestrel finishes a list nobody asked for.', where: 'Solmere, once the world has broken' },
  stillwater: { name: 'The Ninth Form', kind: 'story', what: 'Oda shows the form he does not teach.', where: 'the Ninth Lantern' },
  relief: { name: 'Stand Down', kind: 'story', what: 'Somebody finally relieves Rusk of a post nobody assigned.', where: 'the Engine House, inside Solmere' },
  ...
  pump: { name: 'The Pump', kind: 'story', what: 'Aurelian repairs the first machine he ever built badly.', where: 'Caldwick' },
  ...
  oak: { name: 'The Standing Oak', kind: 'side', what: 'The oak has not moved in nine hundred years and is moving.', where: 'off the road, west of Harrowmere' },
  ...
  cabinet: { name: 'The Cabinet of Species', kind: 'side', what: 'A collection with one drawer that will not close.', where: 'Emberlyn' },
  count: {
  ...
  shift: { name: 'The Last Shift', kind: 'side', what: 'One shift never clocked off.', where: 'the Hollow Mine' },
  yard: { name: 'The Yardmaster', kind: 'side', what: 'Bramblewold has a yardmaster and no yard.', where: 'Bramblewold' },
  brood: { name: 'The Brood of Glass', kind: 'side', what: 'Something is laying in the Glasswaste.', where: 'the Stormspire' },
